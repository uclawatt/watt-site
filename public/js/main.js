document.addEventListener("DOMContentLoaded", function(event) {
    ...
    var dataObj = {
        events: [
            {name: "WATT Spring GM", eventUrl: "https://www.facebook.com/events/598685393813182/", date: "4/4/18", location: "Engr IV 67-124", description: "Welcome to the final General Meeting of the academic year! Come for announcements of our upcoming info sessions, workshops, panels, and socials, as well as some icebreakers to refresh friendships, both old and new. If you're interested in running for an officer position next year your attendance is highly encouraged! New members are welcome! ~There will be Dominos Pizza for all attendees!~"},
