document.addEventListener("DOMContentLoaded", function(event) {
    ...
    var dataObj = {
        events: [
            ...
            {name: 'Self Care Session', eventUrl: "https://www.facebook.com/events/214082259331478/", date: "3/2/18", location: "Engr IV Room 67-124", description: "Come and join us for a chance to destress with other WATT and ACM members through watercolor painting, board games, and fun videos. Snacks will also be provided!"}
        ],
        officers: [
